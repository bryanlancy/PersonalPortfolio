...
`
const paragraph3 = `
    I was having an issue with waking up very early for the job I had at the time and an app that would set off an alarm based on sleep patterns so you'd wake up feeling more rested and read that sunrise can have similar effects.
...
// TODO FIX LINE BREAK!
const paragraph4 = `
    The first time I got an LED wired up to a photoresistor and got my code uploaded and working is when I'd be doing this for the rest of my life.
...
const paragraph5 = `
    ...
    And eventually, in 2021, landed my first full-time software development position and I've been developing full-time ever since.
    I've gotten to work on some cool projects in that time and still frequently work on my own projects at home.
`
